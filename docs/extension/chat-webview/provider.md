...
- Forwarding those actions to the appropriate backend modules, primarily [`SessionManager`](../session-management/README.md).
- Listening to [`SessionUpdateHandler`](../handlers/README.md) and translating ACP session notifications into webview messages.
- Hosting interactive UI flows for permission requests, ask-user questions, and plan approvals via the [`chat_webview_bridges`](bridges.md) modules.
...
- [`permissionBridge`](bridges.md): renders permission-request cards in the chat.
- [`askBridge`](bridges.md): renders ask-user-question forms.
- [`planBridge`](bridges.md): renders plan-approval cards.
...
- [`session_management.md`](../session-management/README.md) — Session lifecycle, connection, and prompt dispatch.
- [`chat_webview_bridges.md`](bridges.md) — Permission, ask, and plan bridge modules.
- [`handlers.md`](../handlers/README.md) — Session update, file system, terminal, and permission handlers.
- [`agent_management.md`](../agent-management/README.md) — Agent spawning, ACP client, and checkpoint system.
- [`webview_ui.md`](../../webview/README.md) — React webview application (`App.tsx`, `bridge.ts`, `Markdown.tsx`).
- [`extension_activation.md`](../activation.md) — Extension entry point and command registration.
- [`utils.md`](../utils/README.md) — Logging, telemetry, and stream utilities.
