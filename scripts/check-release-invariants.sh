...
# The file the README banner points at must exist, or the banner breaks.
# A dedicated dark-theme variant (previously AINxt_logo_icon/AINxt_CTC-02.png) does not
# exist in this tree; the README uses the single light asset for both color schemes
# until a real dark-mode PNG is produced and added here (OSSAUDIT-2026-09-05).
for B in 'assets/AINxt_CTC-01.png'; do
